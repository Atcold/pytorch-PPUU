...
parser.add_argument('-mfile', type=str, default='model=fwd-cnn-ae-fp-bsize=16-ncond=10-npred=20-lrt=0.0001-nhidden=100-nfeature=128-decoder=0-combine=add-gclip=1-nz=64-beta=0.0001-nmix=1-warmstart=1.model')
...
mfile_prior = f'{opt.model_dir}/{opt.mfile}-nfeature={opt.nfeature}-lrt={opt.lrt}-nmixture={opt.n_mixture}.prior'
