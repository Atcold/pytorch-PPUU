...
\begin{figure*}[t!]
    \centering
    \subfigure[$\lambda_U=0.01$]{\includegraphics[width=0.48\textwidth]{figures/driving/svg_reg_prediction-crop.pdf}}
    \subfigure[$\lambda_U=0$]{\includegraphics[width=0.48\textwidth]{figures/driving/svg_no_reg_prediction-crop.pdf}} \\
  ...
  \begin{tabular}{|llll|}
    ...
    \hhline{|====|}
    SVG & 2.6 & 0.0005 & 8717 \\
    SVG + Epistemic Cost & 29.6 & 0.0830 & 1.451 \\
    \hline
  \end{tabular}
}
