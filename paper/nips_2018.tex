...
\begin{figure}
  \centering
    ...
    \includegraphics[width=\textwidth]{images/vlcsnap-2018-02-22-14h40m23s503.png}
  \end{subfigure}
    \caption{Frame from NGSIM dataset after viewpoint transformation and tracking.}

  \begin{subfigure}[b]{0.6\textwidth}
    \includegraphics[width=0.3\textwidth]{images/state_image.png}
  \end{subfigure}
