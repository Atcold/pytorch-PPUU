...
for ts in time_slots:
    df[ts] = \
        pd.read_table(path + ts + '.txt', sep='\s+', header=None, names=(
            'Vehicle ID',
            'Frame ID',
            'Total Frames',
            'Global Time',
...
torch.save(car_sizes, '/home/mbhenaff/projects/pytorch-Traffic-Simulator/scratch/traffic-data-atcold/data_i80_v0/car_sizes.pth')
