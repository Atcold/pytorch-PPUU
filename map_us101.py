...
class US101(RealTraffic):
    ...
    def __init__(self, **kwargs):
        ...
        self._time_slots = (
            './data_us101/trajectories-0750am-0805am',
            './data_us101/trajectories-0805am-0820am',
            './data_us101/trajectories-0820am-0835am',
        )
        self._t_slot = None
        self._black_list = {
            self._time_slots[0]:
